...
public class UpdateEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdateEmail.setEnabled(false);  //Make the button disabled in the beginning until the user is authenticated
        ...
        buttonVerifyUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(userPwd)) {
                    ...
                    editTextPwd.setError("Please enter your password for authentification");
        ...
        firebaseUser.verifyBeforeUpdateEmail(userNewEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete()) {
                    ...
                    Intent intent = new Intent(UpdateEmailActivity.this, StartActivity.class);
