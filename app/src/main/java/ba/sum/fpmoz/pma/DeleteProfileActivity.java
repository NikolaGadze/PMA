...
public class DeleteProfileActivity extends AppCompatActivity {
    ...
    private void showAlertDialog() {
        ...
        //Return to User Profile Acitvity if User presses Cancel Button
        ...
        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(getResources().getColor(R.color.lime));
            }
        });
    ...
    private void deleteUserData(FirebaseUser firebaseUser) {
        ...
        //Delete Data for Relatime Database
        ...
        databaseReference.child(firebaseUser.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                //Finally delete the user after deleting the releated data
                deleteUser();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
